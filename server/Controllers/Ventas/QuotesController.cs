...
namespace server.Controllers
{
    ...
    public class QuotesController : ControllerBase
    {
        ...
        /// <returns>200 con la lista de <see cref="Ventas.QuoteResponse"/>.</returns>
        [HttpGet]
        public async Task<IActionResult> GetAll([FromQuery] Guid? clientId = null, [FromQuery] bool? active = null, [FromQuery] string? status = null)
        {
            ...
            var result = _repo.GetAll<Ventas.QuoteResponse>("sal.SP_GetQuotes", p).ToList();
        ...
        /// <returns>200 con <see cref="Ventas.QuoteResponse"/> o 404 si no existe.</returns>
        [HttpGet("{id:guid}")]
        public async Task<IActionResult> GetById(Guid id)
        {
            ...
            var result = _repo.Get<Ventas.QuoteResponse>("sal.SP_GetQuoteById", p);
            if (result is null)
        ...
        public IActionResult GetLines(Guid id)
        {
            ...
            var result = _repo.GetAll<Ventas.LineResponse>("sal.SP_GetQuoteLines", p);
            return Ok(result);
        }
        ...
        /// <returns>200 con <see cref="Ventas.SP_QuoteResult"/> o 400 si hay error.</returns>
        [HttpPost]
        [RequirePermission("ventas.quotes.create", "Crear cotizaciones")]
        public IActionResult Insert([FromBody] Ventas.QuoteRequest request)
        {
            var p = BuildQuoteParameters(request);

            var result = _repo.Get<Ventas.SP_QuoteResult>("sal.SP_InsertQuote", p);
        ...
        public IActionResult Update(Guid id, [FromBody] Ventas.QuoteRequest request)
        {
            var p = BuildQuoteParameters(request);
            p.Add("@Id", id);

            var result = _repo.Get<Ventas.SP_QuoteResult>("sal.SP_UpdateQuote", p);
        ...
        public IActionResult ChangeStatus(Guid id, [FromBody] Ventas.QuoteStatusRequest request)
        {
            var p = new DynamicParameters();
            p.Add("@Id",     id);
            p.Add("@Status", request.Status);

            var result = _repo.Get<Ventas.SP_QuoteResult>("sal.SP_ChangeQuoteStatus", p);
        ...
        /// </summary>
        /// <param name="id">Identificador único de la cotización.</param>
        /// <returns>200 con <see cref="Ventas.SP_QuoteResult"/> o 400 si no existe.</returns>
        ...
        public IActionResult Toggle(Guid id)
        {
            ...
            var result = _repo.Get<Ventas.SP_QuoteResult>("sal.SP_ToggleQuoteStatus", p);
        ...
        /// </summary>
        /// <param name="id">Identificador único de la cotización.</param>
        /// <returns>200 con <see cref="Ventas.SP_QuoteResult"/> o 400 si no existe o ya fue convertida.</returns>
        [HttpDelete("{id:guid}")]
        ...
        public IActionResult Delete(Guid id)
        {
            ...
            var result = _repo.Get<Ventas.SP_QuoteResult>("sal.SP_DeleteQuote", p);
        ...
        /// <returns>200 con <see cref="Ventas.SP_QuoteResult"/> (Id de la orden nueva) o 400 si hay error.</returns>
        [HttpPost("{id:guid}/convert")]
        [RequirePermission("ventas.quotes.convert", "Convertir cotización en orden de venta")]
        public IActionResult Convert(Guid id, [FromBody] Ventas.ConvertQuoteRequest request)
        {
            var p = new DynamicParameters();
            p.Add("@QuoteId",      id);
            ...
            var result = _repo.Get<Ventas.SP_QuoteResult>("sal.SP_ConvertQuoteToOrder", p);
        ...
        private static DynamicParameters BuildQuoteParameters(Ventas.QuoteRequest request)
        {
            var p = new DynamicParameters();
