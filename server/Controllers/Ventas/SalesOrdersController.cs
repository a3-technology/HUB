...
namespace server.Controllers
{
    ...
    public class SalesOrdersController : ControllerBase
    {
        ...
        /// <returns>200 con la lista de <see cref="SAL.SalesOrderResponse"/>.</returns>
        [HttpGet]
        public async Task<IActionResult> GetAll([FromQuery] Guid? clientId = null, [FromQuery] bool? active = null, [FromQuery] string? status = null)
        {
            ...
            var result = _repo.GetAll<SAL.SalesOrderResponse>("sal.SP_GetSalesOrders", p).ToList();
        ...
        /// <returns>200 con <see cref="SAL.SalesOrderResponse"/> o 404 si no existe.</returns>
        [HttpGet("{id:guid}")]
        public async Task<IActionResult> GetById(Guid id)
        {
            ...
            var result = _repo.Get<SAL.SalesOrderResponse>("sal.SP_GetSalesOrderById", p);
            if (result is null)
        ...
        public IActionResult GetLines(Guid id)
        {
            ...
            var result = _repo.GetAll<SAL.LineResponse>("sal.SP_GetSalesOrderLines", p);
            return Ok(result);
        }
        ...
        /// <returns>200 con <see cref="SAL.SP_SalesOrderResult"/> o 400 si hay error.</returns>
        [HttpPost]
        [RequirePermission("ventas.orders.create", "Crear órdenes de venta")]
        public IActionResult Insert([FromBody] SAL.SalesOrderRequest request)
        {
            var p = BuildOrderParameters(request);

            var result = _repo.Get<SAL.SP_SalesOrderResult>("sal.SP_InsertSalesOrder", p);
        ...
        public IActionResult Update(Guid id, [FromBody] SAL.SalesOrderRequest request)
        {
            var p = BuildOrderParameters(request);
            p.Add("@Id", id);

            var result = _repo.Get<SAL.SP_SalesOrderResult>("sal.SP_UpdateSalesOrder", p);
        ...
        public IActionResult ChangeStatus(Guid id, [FromBody] SAL.SalesOrderStatusRequest request)
        {
            var p = new DynamicParameters();
            p.Add("@Id",     id);
            p.Add("@Status", request.Status);

            var result = _repo.Get<SAL.SP_SalesOrderResult>("sal.SP_ChangeSalesOrderStatus", p);
        ...
        /// </summary>
        /// <param name="id">Identificador único de la orden.</param>
        /// <returns>200 con <see cref="SAL.SP_SalesOrderResult"/> o 400 si no existe.</returns>
        ...
        public IActionResult Toggle(Guid id)
        {
            ...
            var result = _repo.Get<SAL.SP_SalesOrderResult>("sal.SP_ToggleSalesOrderStatus", p);
        ...
        /// </summary>
        /// <param name="id">Identificador único de la orden.</param>
        /// <returns>200 con <see cref="SAL.SP_SalesOrderResult"/> o 400 si no existe o ya generó un contrato.</returns>
        [HttpDelete("{id:guid}")]
        ...
        public IActionResult Delete(Guid id)
        {
            ...
            var result = _repo.Get<SAL.SP_SalesOrderResult>("sal.SP_DeleteSalesOrder", p);
        ...
        /// <returns>200 con <see cref="SAL.SP_SalesOrderResult"/> (Id del contrato nuevo) o 400 si hay error.</returns>
        [HttpPost("{id:guid}/convert")]
        [RequirePermission("ventas.orders.convert", "Convertir orden de venta en contrato")]
        public IActionResult Convert(Guid id, [FromBody] SAL.ConvertOrderRequest request)
        {
            var p = new DynamicParameters();
            p.Add("@OrderId",   id);
            ...
            var result = _repo.Get<SAL.SP_SalesOrderResult>("sal.SP_ConvertOrderToContract", p);
        ...
        private static DynamicParameters BuildOrderParameters(SAL.SalesOrderRequest request)
        {
            var p = new DynamicParameters();
