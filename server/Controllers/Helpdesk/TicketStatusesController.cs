...
namespace server.Controllers
{
    ...
    public class TicketStatusesController : ControllerBase
    {
        ...
        public IActionResult GetAll([FromQuery] bool? active = null)
        {
            ...
            var result = _repo.GetAll<HD.TicketStatusResponse>("hd.SP_GetTicketStatuses", p);
            return Ok(result);
        }
        ...
        /// <returns>200 con <see cref="HD.TicketStatusResponse"/> o 404 si no existe.</returns>
        [HttpGet("{id:guid}")]
        public IActionResult GetById(Guid id)
        {
            ...
            var result = _repo.Get<HD.TicketStatusResponse>("hd.SP_GetTicketStatusById", p);
            if (result is null)
        ...
        public IActionResult GetTransitions([FromQuery] Guid? fromStatusId = null)
        {
            ...
            var result = _repo.GetAll<HD.TicketStatusTransitionResponse>("hd.SP_GetTicketStatusTransitions", p);
            return Ok(result);
        }
        ...
        /// <returns>200 con <see cref="HD.SP_TicketStatusResult"/> o 400 si hay error.</returns>
        [HttpPost]
        [RequirePermission("helpdesk.statuses.create", "Crear estados de ticket")]
        public IActionResult Insert([FromBody] HD.TicketStatusRequest request)
        {
            var p = new DynamicParameters();
            ...
            var result = _repo.Get<HD.SP_TicketStatusResult>("hd.SP_InsertTicketStatus", p);
        ...
        public IActionResult Update(Guid id, [FromBody] HD.TicketStatusRequest request)
        {
            var p = new DynamicParameters();
            p.Add("@Id",                     id);
            p.Add("@Name",                   request.Name.Trim());
            ...
            var result = _repo.Get<HD.SP_TicketStatusResult>("hd.SP_UpdateTicketStatus", p);
        ...
        /// <returns>200 con <see cref="HD.SP_TicketStatusResult"/> o 400 si no existe o violaría el invariante mínimo del catálogo.</returns>
        ...
        public IActionResult Toggle(Guid id)
        {
            ...
            var result = _repo.Get<HD.SP_TicketStatusResult>("hd.SP_ToggleTicketStatusStatus", p);
        ...
        /// <param name="id">Identificador único del estado.</param>
        /// <returns>200 con <see cref="HD.SP_TicketStatusResult"/> o 400 si no existe o está en uso.</returns>
        [HttpDelete("{id:guid}")]
        ...
        public IActionResult Delete(Guid id)
        {
            ...
            var result = _repo.Get<HD.SP_TicketStatusResult>("hd.SP_DeleteTicketStatus", p);
