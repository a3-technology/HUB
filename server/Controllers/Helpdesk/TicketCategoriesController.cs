...
namespace server.Controllers
{
    ...
    public class TicketCategoriesController : ControllerBase    
    {
        ...
        public IActionResult GetAll([FromQuery] bool? active = null)
        {
            ...
            var result = _repo.GetAll<HD.CategoryResponse>("hd.SP_GetTicketCategories", p);
        ...
        /// <returns>200 con <see cref="HD.CategoryResponse"/> o 404 si no existe.</returns>
        [HttpGet("{id:guid}")]
        public IActionResult GetById(Guid id)
        {
            ...
            var result = _repo.Get<HD.CategoryResponse>("hd.SP_GetTicketCategoryById", p);
            if (result is null)
        ...
        /// <returns>200 con <see cref="HD.SP_CategoryResult"/> o 400 si hay error.</returns>
        [HttpPost]
        [RequirePermission("helpdesk.categories.create", "Crear categorías")]
        public IActionResult Insert([FromBody] HD.CategoryRequest request)
        {
            var p = new DynamicParameters();
            p.Add("@Name",        request.Name.Trim());
            p.Add("@Description", request.Description?.Trim());

            var result = _repo.Get<HD.SP_CategoryResult>("hd.SP_InsertTicketCategory", p);
        ...
        public IActionResult Update(Guid id, [FromBody] HD.CategoryRequest request)
        {
            var p = new DynamicParameters();
            p.Add("@Id",          id);
            p.Add("@Name",        request.Name.Trim());
            ...
            var result = _repo.Get<HD.SP_CategoryResult>("hd.SP_UpdateTicketCategory", p);
        ...
        /// <returns>200 con <see cref="HD.SP_CategoryResult"/> o 400 si no existe.</returns>
        ...
        public IActionResult Toggle(Guid id)
        {
            ...
            var result = _repo.Get<HD.SP_CategoryResult>("hd.SP_ToggleTicketCategoryStatus", p);
        ...
        /// <param name="id">Identificador único de la categoría.</param>
        /// <returns>200 con <see cref="HD.SP_CategoryResult"/> o 400 si no existe o está en uso.</returns>
        [HttpDelete("{id:guid}")]
        ...
        public IActionResult Delete(Guid id)
        {
            ...
            var result = _repo.Get<HD.SP_CategoryResult>("hd.SP_DeleteTicketCategory", p);
